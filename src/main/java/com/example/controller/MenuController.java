...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("adminInfo", "超级管理员信息", "layui-icon-table", "adminInfo"));
			array.add(getJsonObject("businessInfo", "管理员信息", "layui-icon-table", "businessInfo"));
			...
			array.add(getJsonObject("checkInfo", "人员检测信息", "layui-icon-table", "checkInfo"));
			array.add(getJsonObject("submitInfo", "外来人员报备", "layui-icon-table", "submitInfo"));
			array.add(getJsonObject("richtextInfo", "防疫须知信息", "layui-icon-table", "richtextInfo"));
			array.add(getJsonObject("advertiserInfo", "公告信息", "layui-icon-table", "advertiserInfo"));
			array.add(getJsonObject("typeInfo", "疫情用品类型", "layui-icon-table", "typeInfo"));
			array.add(getJsonObject("goodsInfo", "疫情用品详情", "layui-icon-table", "goodsInfo"));
		...
		dataArray.add(getJsonObject("richtextInfoComment", "防疫须知评论", "layui-icon-group", "richtextInfoComment"));
    ...
    public Result<Map<String, Integer>> getTotle() {
		...
		resultMap.put("checkInfo", checkInfoService.findAll().size());
